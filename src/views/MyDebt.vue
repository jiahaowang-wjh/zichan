            ...
            <div class='my-debt-list-search'>
                <div class='my-debt-list-search-form'>
                    <el-form ref="form">
                        <el-form-item>
                            <span>相对人:</span>
                            <el-select placeholder="请选择相对人" v-model='SelectForm.Relevant'>
            ...
            <div class='my-debt-list-content'>
                ...
                <div class='my-debt-list-content-tab'>
                    <div class='my-debt-list-content-tab-item' v-for='(item,index) in MyDebtMsg' :key='index'>
                        ...
                        <span>
                            <button v-show="item.status === '0'" @click='GoAssess(index)'>资产评估</button>
                            <button v-show="item.status === '3' && item.stage === '1'" @click='EnterContract(index)'>录入合同
                            </button>
...
export default {
    ...
    methods: {
        ...
        // 资产评估
        GoAssess (index) {
            window.sessionStorage.setItem('relativePerId', this.MyDebtMsg[index].relativePerId)
            window.sessionStorage.setItem('propertId', this.MyDebtMsg[index].propertId)
